                                ...
                                @foreach($posts as $post)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('posts.edit',  $post) }}"><i class="fa fa-edit fa-fw text-info"></i></a>
                                            <a
                                            ...
                                            <form action="{{ route('posts.destroy', $post) }}" method="POST" id="delete-post-{{ $post->id }}" style="display: none !important;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
